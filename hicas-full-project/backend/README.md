...
Supabase dùng chung. Test cũng tự từ chối URL PostgreSQL không phải local/Docker,
kể cả khi biến này bị đặt nhầm. Backend CI dùng PostgreSQL service tạm thời, apply
migration trước và đặt `RUN_DATABASE_E2E=1`.
